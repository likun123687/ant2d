...
public:
    ...
    MAKE_MOCK1(debug_shader_desc, const sg_shader_desc*(sg_backend backend));
    MAKE_MOCK1(debug_attr_slot, int(const char* attr_name));
    MAKE_MOCK2(debug_image_slot, int(sg_shader_stage stage, const char* img_name));
    MAKE_MOCK2(debug_uniformblock_slot, int (sg_shader_stage stage, const char* ub_name));
    MAKE_MOCK2(debug_uniformblock_size, size_t (sg_shader_stage stage, const char* ub_name));
    MAKE_MOCK3(debug_uniform_offset, int (sg_shader_stage stage, const char* ub_name, const char* u_name));
    MAKE_MOCK3(debug_uniform_desc, sg_shader_uniform_desc (sg_shader_stage stage, const char* ub_name, const char* u_name));
